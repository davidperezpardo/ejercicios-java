package matematicas;
/**
 * funciones variadas para jugar con los números.
 * corresponde a los ejercicios 1-14 (tema 8 de funciones).
 * 
...
public class varias {
   ...
   * 
   * @param x numero long que queremos invertir
   ...
   * empezando el primer dígito en la posicion 0.
   * se voltea el nº primero,para poder contar de izquierda a derecha la posición.
   * 
  ...
  /**
   * Nos devuelve la posición de un dígito dentro de un nº entero.
   * si no se encuentra,devuelve -1.
   * Utilizamos dos funciones del mismo paquete.
   * @param n numero en el que vamos a buscar la posicion
   *          del número.
   * @param pos int,dígito del que queremos saber su posición.
   * @return  devuelve la posicion del dígito,y si no está en el número
   * devolverá -1.
   */
  ...
  /**
   * Quita n dígitos por delante (de izquierda a derecha)
   * "utilizando dos funciones del mismo paquete".
   * 
   ...
   * @param pegar   Lo/s dígito/s que le queremos pegar (tipo cadena).
   * @return    devuelve nº entero con los dígitos "pegados".
   */
  public static int pegaPorDetras(int n, String pega) {
   ...
   * @return    Devuelve nº entero con los dígitos pegados.
   */
  public static int pegaPorDelante(int n, String pega) {
