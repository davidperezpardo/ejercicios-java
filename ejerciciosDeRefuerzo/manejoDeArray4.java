...
public class manejoDeArray4 {
  ...
  public static void main(String[] args) {
     ...
     * palabra y asignándole un índice. Al acabar,el programa imprime las palabras
     * almacenadas en el orden asignado por el usuario(índice). No se permite la
    ...
    /**
     * bucle exterior e interior,con el interior vamos comprobando todos los valores
     * del array tantas veces como tamaño del (array-1), y buscamos primero el valor
     * mas bajo (1) y cuando lo encuentre,imprimimos la palabra, que coincidira con
     * el valor (1) dado en el array de enteros
     */
    System.out.print("palabras ordenadas por su índice: ");
    for (int i = 0; i < tamaArray; i++) {
